...
BUG_ID = 42470017  # the bug we're using to validate the pipeline end-to-end
MODEL_NAME = "gemini/gemini-2.5-flash"
COST_LIMIT = 0.50  # stop the agent if a single attempt would cost more than this (USD)
